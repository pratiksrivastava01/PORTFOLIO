    ...
    <div className=" bg-primary w-full h-screen flex justify-center items-center">
      <div className="w-11/12 relative bg-primary-lighter rounded-lg overflow-hidden shadow-md shadow-primary-lighter border-lines border-2 h-90per">
        ...
        <div className="border-t-2 absolute border-t-lines flex w-full">
          ...
          <a target="_blank" href={"https://github.com/pratiksrivastava01"}className={` text-secondary hover:text-white text-headline  flex items-center last:ml-auto border-r-0 border-l-2 border-l-lines inline-block px-3  py-3 hover:border-b-accent border-b-primary-lighter transition border-b-2  `}>
            <span className="text-xs block mr-1">@pratiksrivastava01</span><i className="ri-github-fill"></i>
          </a>
        </div>
      </div>
    </div>
