  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-full ">  
        <div className='pr-20'>
          <h1 className="text-xs pl-1 text-white">Nameste world, I am </h1>
          <h1 className="text-6xl font-thin text-accent-orange">Pratik Srivastava</h1>
          <h1 ref={typewriterRef} className="text-2xl font-thin text-secondary-purple flex align-baseline">
             {<Typewriter
                options={{
                  strings: ['Front-end Developer', 'Going to be Full Stack Developer', 'DevOps Enthusiast'],
                  autoStart: true,
                  loop: true,
                }} 
              />}
